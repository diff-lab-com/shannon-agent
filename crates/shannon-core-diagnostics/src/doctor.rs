...
//!
//! ```no_run
//! use shannon_core_diagnostics::doctor::Doctor;
//!
...
use crate::internal_logging::InternalLogLevel;

// Re-export Settings from base crate for convenience
pub use shannon_core_base::Settings;
