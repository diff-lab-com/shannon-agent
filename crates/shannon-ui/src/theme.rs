...
pub struct Theme {
    ...
    // Message background colors (subtle tinting)
...
impl Theme {
    ...
    pub fn default_dark() -> Self {
        ...
        let purple = Color::Rgb(149, 137, 218);
        let gold = Color::Rgb(192, 163, 110);
        let peach = Color::Rgb(221, 158, 117);
        let green = Color::Rgb(104, 157, 106);
        let red = Color::Rgb(195, 64, 67);
        let cyan = Color::Rgb(134, 193, 221);
        let dim = Color::Rgb(98, 100, 116);
        let fg = Color::Rgb(220, 212, 188);
        Self {
            name: "dark".to_string(),
            user_msg: blue,
            assistant_msg: purple,
            system_msg: gold,
            tool_msg: peach,
            user_msg_bg: Color::Rgb(25, 38, 30),
            assistant_msg_bg: Color::Rgb(25, 28, 48),
            primary: blue,
            secondary: gold,
            accent: purple,
            border: dim,
            border_dim: Color::Rgb(55, 58, 72),
            header_text: blue,
            success: green,
            ...
            muted: dim,
            text: fg,
            text_dim: Color::Rgb(140, 142, 160),
            diff_added: green,
            diff_removed: red,
            diff_header: cyan,
            diff_added_bg: Color::Rgb(30, 50, 30),
            diff_removed_bg: Color::Rgb(50, 30, 32),
            diff_context: dim,
            ...
            syntax_type: blue,
            syntax_variable: fg,
            syntax_operator: gold,
            tool_read: cyan,
            tool_write: gold,
            tool_search: purple,
            tool_bash: green,
            fullscreen_bg: Color::Rgb(24, 26, 34),
            ...
            subagent_7: peach,
            subagent_8: dim,
            heading: Color::Rgb(230, 195, 132),
            bold_text: fg,
            italic_text: Color::Rgb(160, 155, 140),
            blockquote: dim,
            inline_code: gold,
            inline_code_bg: Color::Rgb(40, 42, 52),
            context_bar_fg: blue,
    ...
    pub fn default_light() -> Self {
        Self {
            ...
            assistant_msg_bg: Color::Rgb(230, 238, 250),
            ...
            bold_text: Color::Rgb(30, 30, 30),
            italic_text: Color::Rgb(80, 80, 80),
            blockquote: Color::Rgb(130, 130, 130),
            inline_code: Color::Rgb(180, 120, 0),
            inline_code_bg: Color::Rgb(230, 230, 230),
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            user_msg_bg: Color::Rgb(35, 55, 45),
            assistant_msg_bg: Color::Rgb(40, 35, 60),
            ...
            text_dim: Color::Rgb(139, 143, 182),
            ...
            heading: Color::Rgb(241, 250, 140),
            bold_text: Color::Rgb(248, 248, 242),
            italic_text: Color::Rgb(98, 114, 164),
            blockquote: Color::Rgb(98, 114, 164),
            inline_code: Color::Rgb(241, 250, 140),
            inline_code_bg: Color::Rgb(50, 52, 68),
    ...
    pub fn tokyonight() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(28, 32, 34),
            ...
            blockquote: comment,
            inline_code: orange,
            inline_code_bg: Color::Rgb(32, 34, 48),
            context_bar_fg: blue,
    ...
    pub fn catppuccin_mocha() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: mauve,
            user_msg_bg: Color::Rgb(28, 40, 30),
            assistant_msg_bg: Color::Rgb(28, 30, 50),
            primary: blue,
            secondary: yellow,
            accent: mauve,
            border: surface0,
            ...
            heading: yellow,
            bold_text: text_c,
            italic_text: overlay0,
            blockquote: overlay0,
            inline_code: peach,
            inline_code_bg: Color::Rgb(36, 36, 52),
            context_bar_fg: blue,
    ...
    pub fn gruvbox_dark() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(42, 44, 36),
            assistant_msg_bg: Color::Rgb(36, 38, 46),
            primary: yellow,
            secondary: orange,
            accent: purple,
            border: dim,
    ...
    pub fn nord() -> Self {
        ...
        Self {
            ...
            user_msg_bg: Color::Rgb(42, 52, 50),
            assistant_msg_bg: Color::Rgb(40, 48, 68),
            primary: frost_blue,
            ...
            subagent_8: dim,
            heading: aurora_yellow,
            bold_text: snow_storm,
            italic_text: dim,
            blockquote: dim,
            inline_code: aurora_orange,
            inline_code_bg: Color::Rgb(52, 58, 72),
    ...
    pub fn kanagawa() -> Self {
        ...
        Self {
            ...
            user_msg_bg: Color::Rgb(26, 30, 30),
            assistant_msg_bg: Color::Rgb(24, 26, 40),
            primary: wave_blue,
            ...
            subagent_7: peach,
            subagent_8: dim,
            heading: ronin_yellow,
            bold_text: old_white,
            italic_text: dim,
            blockquote: dim,
            inline_code: spring_yellow,
            inline_code_bg: Color::Rgb(34, 36, 46),
    ...
    pub fn monokai() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(40, 42, 32),
            assistant_msg_bg: Color::Rgb(34, 36, 44),
            primary: yellow,
            secondary: orange,
            accent: purple,
            ...
            blockquote: comment,
            inline_code: orange,
            inline_code_bg: Color::Rgb(45, 46, 40),
            context_bar_fg: yellow,
    ...
    pub fn onedark() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(40, 46, 44),
            assistant_msg_bg: Color::Rgb(38, 42, 56),
            primary: blue,
            secondary: yellow,
            accent: purple,
            border: gutter,
            ...
            bold_text: fg,
            italic_text: comment,
            blockquote: Color::Rgb(85, 90, 105),
            inline_code: orange,
            inline_code_bg: Color::Rgb(40, 44, 52),
            context_bar_fg: blue,
    ...
    pub fn everforest() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(45, 54, 50),
            assistant_msg_bg: Color::Rgb(42, 50, 60),
            primary: blue,
            secondary: yellow,
            accent: green,
            border: dim,
            ...
            blockquote: dim,
            inline_code: yellow,
            inline_code_bg: Color::Rgb(40, 45, 40),
            context_bar_fg: blue,
    ...
    pub fn ayu() -> Self {
        ...
        Self {
            ...
            user_msg_bg: Color::Rgb(15, 25, 15),
            assistant_msg_bg: Color::Rgb(15, 20, 30),
            primary: blue,
            secondary: orange,
            ...
            blockquote: comment,
            inline_code: yellow,
            inline_code_bg: Color::Rgb(30, 33, 44),
            context_bar_fg: blue,
    ...
    pub fn flexoki() -> Self {
        ...
        Self {
            ...
            system_msg: yellow,
            tool_msg: purple,
            user_msg_bg: Color::Rgb(42, 42, 36),
            assistant_msg_bg: Color::Rgb(36, 38, 44),
            primary: blue,
            secondary: yellow,
            accent: purple,
            border: dim,
            ...
            blockquote: dim,
            inline_code: orange,
            inline_code_bg: Color::Rgb(40, 40, 38),
            context_bar_fg: blue,
...
fn load_custom_theme(name: &str) -> Option<Theme> {
    ...
    Some(Theme {
        ...
        user_msg_bg: resolve_color(&file.user_msg_bg, base.user_msg_bg),
        assistant_msg_bg: resolve_color(&file.assistant_msg_bg, base.assistant_msg_bg),
        ...
        heading: resolve_color(&file.heading, base.heading),
        bold_text: resolve_color(&file.bold_text, base.bold_text),
        italic_text: resolve_color(&file.italic_text, base.italic_text),
        blockquote: resolve_color(&file.blockquote, base.blockquote),
        inline_code: resolve_color(&file.inline_code, base.inline_code),
        inline_code_bg: resolve_color(&file.inline_code_bg, base.inline_code_bg),
...
struct ThemeFile {
    ...
    assistant_msg_bg: Option<String>,
    ...
    bold_text: Option<String>,
    italic_text: Option<String>,
...
mod tests {
    ...
    fn test_default_dark_theme() {
        ...
        assert_eq!(theme.user_msg, Color::Rgb(126, 156, 216));
        assert_eq!(theme.assistant_msg, Color::Rgb(149, 137, 218));
    }
