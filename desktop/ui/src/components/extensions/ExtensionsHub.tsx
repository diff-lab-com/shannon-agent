        ...
        <div className="flex items-center justify-between mb-lg">
          ...
          <div className="flex items-center gap-sm">
            ...
            <div className="flex bg-surface-container-low rounded-lg p-xs gap-xs">
              <Button onClick={() => setFilterMode('trending')} variant="ghost" size="xs" className={cn("px-sm py-xs rounded-md text-label-sm font-bold cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:outline-none", filterMode === 'trending' ? 'bg-primary text-on-primary shadow-sm' : 'text-on-surface-variant hover:bg-surface-container-high')}>{t('extensions.hub.trending')}</Button>
              <Button onClick={() => setFilterMode('recent')} variant="ghost" size="xs" className={cn("px-sm py-xs rounded-md text-label-sm font-bold cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:outline-none", filterMode === 'recent' ? 'bg-primary text-on-primary shadow-sm' : 'text-on-surface-variant hover:bg-surface-container-high')}>{t('extensions.hub.recent')}</Button>
            </div>
