...
- **Every line auditable** — Apache-2.0, no black boxes. <!-- metrics:start:intro -->Every line of code is auditable, and every behavior is verified by **12,640 automated tests**.<!-- metrics:end:intro -->
