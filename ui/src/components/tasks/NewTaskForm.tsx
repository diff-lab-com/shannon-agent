    ...
    <div className="bg-surface-container-lowest border border-primary/30 rounded-xl p-lg mb-lg flex flex-col gap-md shadow-sm">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          {showMeta ? 'Hide options' : 'Add options'}
        </button>
      </div>
      <textarea
      ...
      {showMeta ? (
        <div id="new-task-meta" className="grid grid-cols-1 md:grid-cols-2 gap-md">
          <label className="flex flex-col gap-xs">
            <span className="font-label-md text-on-surface-variant">Assignee (optional)</span>
            <input
              type="text"
          ...
          <label className="flex flex-col gap-xs">
            <span className="font-label-md text-on-surface-variant">Priority</span>
            <select
              value={priority}
