...
[GitHub Release](https://github.com/diff-lab-com/shannon-agent/releases):
...
curl -L -o shannon-gateway https://github.com/diff-lab-com/shannon-agent/releases/latest/download/shannon-gateway-darwin-arm64
